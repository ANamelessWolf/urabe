...
class ConnectionError
{
    ...
    public function get_err_context()
    {
        ...
        return UrabeSettings::$show_error_context ? $this->err_context : null;
    }
    /**
    ...
    {
        if (UrabeSettings::$show_error_details) {
            $err_context = array();
            if (UrabeSettings::$show_error_context)
                foreach (UrabeSettings::$errors as &$error) {
