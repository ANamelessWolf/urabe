...
use LocalConnection as GlobalLocalConnection;
use Urabe\Urabe;
 ...
 */
class EmployeeServiceExample extends HasamiWebService
{
    /**
    ...
    public function __construct()
    {
        parent::__construct(new LocalConnection(), "employees", "emp_no");
        //This changes default status for the given services
        $this->services->set_status("DELETE", ServiceStatus::BLOCKED);
        //This mode will simulate the user is logged executing the function 
        $this->services->set_status("POST", ServiceStatus::LOGGED);
